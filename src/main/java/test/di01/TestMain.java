...
public class TestMain {
	public static void main(String[] args) {
		// 스프링이 di01.xml에 설정된 bean객체들을 생헝해 준다.
		ApplicationContext ac = new ClassPathXmlApplicationContext("di01.xml");
		...
		System.out.println("controller1 : "+ controller1.hashCode());
		controller.service();
		System.out.println("---------------------------------------------");
